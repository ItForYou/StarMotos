package com.dreamforone.moyeopet;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lat, lng 좌표처리 값 가져오기
        LocationPosition.act= com.dreamforone.moyeopet.MainActivity.this;
        LocationPosition.setPosition(com.dreamforone.moyeopet.MainActivity.this);
    ...
    WebChromeClient chrome;
    {
        chrome = new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                new AlertDialog.Builder(com.dreamforone.moyeopet.MainActivity.this)
                        .setMessage("\n" + message + "\n")
            ...
            public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(com.dreamforone.moyeopet.MainActivity.this);
                builder.setTitle("내 위치");
                builder.setMessage("현재 위치를 잡으시겠습니까?");
...
//                    filePathCallbackLollipop.onReceiveValue(null);
...

    {
        client = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                Log.d("url",url);
                Log.d("position1",LocationPosition.lat+"");
                Log.d("position2",LocationPosition.lng+"");
                String host=Uri.parse(url).getHost();
                if( url.startsWith("http://") || url.startsWith("https://") ) {
                    ...
                    if (host.equals("m.facebook.com") || host.equals("www.facebook.com") || host.equals("facebook.com")||host.equals("nid.naver.com")) {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if(url.startsWith("https://m.facebook.com/v3.1/dialog/oauth")){
                    ...
                    webView.loadUrl("javascript:sessionStorage.setItem('lat', '')");
                    webView.loadUrl("javascript:sessionStorage.setItem('lat', '"+LocationPosition.lat+"')");
                    webView.loadUrl("javascript:sessionStorage.setItem('lng', '')");
                    webView.loadUrl("javascript:sessionStorage.setItem('lng', '"+LocationPosition.lng+"')");
                }
    ...
    class WebJavascriptEvent{
        ...
        public void login(String mb_id,String mb_name){
            Common.savePref(com.dreamforone.moyeopet.MainActivity.this,"mb_id",mb_id);
            Common.savePref(com.dreamforone.moyeopet.MainActivity.this,"mb_name",mb_name);
        }
        @JavascriptInterface
        public void logout(){
            Common.savePref(com.dreamforone.moyeopet.MainActivity.this,"mb_id","");
            Common.savePref(com.dreamforone.moyeopet.MainActivity.this,"mb_name","");
        }
