...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lat, lng 좌표처리 값 가져오기
        LocationPosition.act= com.dreamforone.moyeopet.SplashActivity.this;
        LocationPosition.setPosition(com.dreamforone.moyeopet.SplashActivity.this);
    ...
    public void goHandler() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(getApplicationContext(), com.dreamforone.moyeopet.MainActivity.class));
                finish();
